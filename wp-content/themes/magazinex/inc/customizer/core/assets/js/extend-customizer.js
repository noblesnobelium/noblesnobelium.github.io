		...
		wp.customize.bind(
			...
			function () {
				...
				wp.customize.section.each(
					function ( section ) {
						if (
							'magazinex_section' !== section.params.type ||
				...
				wp.customize.panel.each(
					function ( panel ) {
						if (
							'magazinex_panel' !== panel.params.type ||
		...
		wp.customize.Panel = wp.customize.Panel.extend(
			{
				attachEvents         : function () {
					...
					if (
						'magazinex_panel' !== this.params.type ||
				...
				isContextuallyActive : function () {
					...
					if ( 'magazinex_panel' !== this.params.type ) {
		...
		wp.customize.Section = wp.customize.Section.extend(
			{
				attachEvents         : function () {
					...
					if (
						'magazinex_section' !== this.params.type ||
				...
				isContextuallyActive : function () {
					...
					if ( 'magazinex_section' !== this.params.type ) {
				...
				wp.customize.control.each(
					function ( ctrl, i ) {
						...
						if ( description.length ) {
							...
							li_wrapper.append( '<i class="magazinex-control-tooltip dashicons dashicons-editor-help" title="' + tooltip + '"></i>' );
						}
					}
				);
			}
 ...
 *
 * Currently used for the MagazineX Upseel section only.
 */
(
	function ( $, api ) {
		api.sectionConstructor[ 'magazinex-upsell-section' ] = api.Section.extend(
			{
