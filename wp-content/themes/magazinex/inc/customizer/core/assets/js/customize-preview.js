...
( function ( $ ) {
	...
	wp.customize(
		'magazinex_footer_copyright_alignment_setting',
		function ( value ) {
			value.bind(
				function ( alignment ) {
	...
	wp.customize(
		'magazinex_main_footer_layout_display_type',
		function ( value ) {
			value.bind(
				function ( layout ) {
					var display_type = layout;
					...
					if ( display_type === 'type_two' ) {
						$( '#colophon' ).removeClass( 'magazinex-footer--classic-bordered' ).addClass( 'magazinex-footer--classic' );
					} else if ( display_type === 'type_three' ) {
						$( '#colophon' ).removeClass( 'magazinex-footer--classic' ).addClass( 'magazinex-footer--classic-bordered' );
					} else if ( display_type === 'type_one' ) {
						$( '#colophon' ).removeClass( 'magazinex-footer--classic magazinex-footer--classic-bordered' );
					}
				}
			);
		}
